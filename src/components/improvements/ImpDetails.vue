<template>
  <div class="imp-details-component">
    <div class="super-container">
      ...
      <div class="row">
        <div class="col">Improvement Details Component</div>
        <div class="col"></div>
      </div>
    ...
    <div id="temporary-container" class="nfr">
      ...
      <div><strong>Title:</strong> {{ impObj.title }}</div>
      <div style="white-space: pre">
        <strong>Description:</strong>
        <div>{{ impObj.description }}</div>
      </div>
      <div style="white-space: pre">
        <strong>Problem:</strong>
        <div>{{ impObj.problem }}</div>
      </div>
      <div style="white-space: pre">
        <strong>Intended Result:</strong>
        <div>{{ impObj.result }}</div>
      </div>
      <div>
      ...
      <con-item v-bind:topCon="true" v-bind:condition="topCondition"></con-item>
